<template>
  <article class="border border-gray-400 shadow-sm p-6 flex flex-col md:flex-row">
    ...
    <div class="flex flex-row md:flex-col justify-center items-center md:items-end flex-1 pt-4 md:py-0">
